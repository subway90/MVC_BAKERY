            ...
            <form action="<?= URL ?>thanh-toan" method="post" class="pt-0" data-aos="fade-up" data-aos-delay="600">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 ps-1 form-floating mb-3">
                        <input readonly value="<?= isset($_SESSION['user']['full_name']) ? $_SESSION['user']['full_name'] : '' ?>" type="text" class="form-control"
                            id="fullname" placeholder="bống béo bread">
                        <label for="fullname">Tên của bạn<span class="ms-1 text-danger">&#10033;</span></label>
                    </div>
                    <div class="col-lg-6 col-12 ps-1 form-floating mb-3">
                        <input readonly value="<?= isset($_SESSION['user']['username']) ? $_SESSION['user']['username'] : '' ?>" type="text" class="form-control"
                    ...
                    <div class="col-12 ps-1 form-floating mb-3">
                        <input readonly value="<?= isset($_SESSION['user']['email']) ? $_SESSION['user']['email'] : '' ?>" type="text" class="form-control"
